...
public class NoteController {
	...
	NoteRepository noteRepository = (NoteRepository) act.getBean("noteRepository");
	...
	public String saveNote(@RequestParam("noteId") String noteId, @RequestParam("noteTitle") String noteTitle,
			@RequestParam("noteContent") String noteContent, @RequestParam("noteStatus") String noteStatus) {

		Note note = (Note) act.getBean("note");
